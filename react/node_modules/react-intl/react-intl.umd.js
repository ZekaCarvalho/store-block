    ...
    */
    ...
    function injectIntl(WrappedComponent, options) {
        ...
        var WithIntl = function (props) { return (React.createElement(IntlConsumer, null, function (intl) {
            ...
            return (React.createElement(WrappedComponent, __assign$5({}, props, intlProp, { ref: forwardRef ? props.forwardedRef : null })));
        })); };
        WithIntl.displayName = "injectIntl(" + getDisplayName(WrappedComponent) + ")";
        WithIntl.WrappedComponent = WrappedComponent;
        if (forwardRef) {
            return hoistNonReactStatics$1(React.forwardRef(function (props, ref) { return (React.createElement(WithIntl, __assign$5({}, props, { forwardedRef: ref }))); }), WrappedComponent);
        }
    ...
    function setTimeZoneInOptions(opts, timeZone) {
        return Object.keys(opts).reduce(function (all, k) {
            all[k] = __assign$7({ timeZone: timeZone }, opts[k]);
            return all;
        }, {});
    }
    function deepMergeOptions(opts1, opts2) {
        var keys = Object.keys(__assign$7(__assign$7({}, opts1), opts2));
        return keys.reduce(function (all, k) {
            all[k] = __assign$7(__assign$7({}, (opts1[k] || {})), (opts2[k] || {}));
            return all;
        }, {});
    }
    function deepMergeFormatsAndSetTimeZone(f1, timeZone) {
        ...
        return __assign$7(__assign$7(__assign$7({}, mfFormats), f1), { date: deepMergeOptions(setTimeZoneInOptions(mfFormats.date, timeZone), setTimeZoneInOptions(f1.date || {}, timeZone)), time: deepMergeOptions(setTimeZoneInOptions(mfFormats.time, timeZone), setTimeZoneInOptions(f1.time || {}, timeZone)) });
    }
    ...
    function prepareIntlMessageFormatHtmlOutput(chunks, shouldWrap) {
        return Array.isArray(chunks) && shouldWrap
            ? React.createElement.apply(React__namespace, __spreadArrays$3([React.Fragment, null], chunks)) : chunks;
    }
    function formatMessage(_a, state, messageDescriptor, values) {
        ...
        var patchedValues = assignUniqueKeysToFormatXMLElementFnArgument(__assign$7(__assign$7({}, defaultRichTextElements), (values || {})));
    ...
    function createIntl(config, cache) {
        ...
        var resolvedConfig = __assign$8(__assign$8({}, DEFAULT_INTL_CONFIG), config);
    ...
    var FormattedRelativeTime = /** @class */ (function (_super) {
        ...
        FormattedRelativeTime.prototype.render = function () {
            ...
            return (React.createElement(Context.Consumer, null, function (intl) {
                ...
                var formattedRelativeTime = formatRelativeTime(currentValue, currentUnit, __assign$9({}, _this.props));
                if (typeof children === 'function') {
        ...
        FormattedMessage.prototype.render = function () {
            ...
            return (React.createElement(Context.Consumer, null, function (intl) {
                ...
                if (Component) {
                    ...
                    return React.createElement.apply(React__namespace, __spreadArrays$4([Component, null], nodes));
                }
                return nodes;
            }));
        };
