...
var DisplayNames = /** @class */ (function () {
    function DisplayNames(locales, options) {
        ...
        var r = ecma402_abstract_1.ResolveLocale(DisplayNames.availableLocales, requestedLocales, { localeMatcher: matcher }, [], // there is no relevantExtensionKeys
        ...
        var type = ecma402_abstract_1.GetOption(options, 'type', 'string', ['language', 'currency', 'region', 'script'], 'language');
